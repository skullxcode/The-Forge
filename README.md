...
**[https://skullxcode.github.io/The-Forge/index.html](https://skullxcode.github.io/The-Forge/index.html)**
...
* `index.html`: The main landing page for the design system.
* `colors.html`: Documentation for the color palette.
* `foundations.html`: A page detailing the foundational elements of the system.
* `components.html`: A gallery showcasing all UI components.
* `utilities.html`: A reference guide for utility classes.
* `style.css`: The single stylesheet that contains all the styling for the project and the design system components.
...
1.  **Clone the repository:**
    ...
    ```
2.  **View the project:**
    Open any of the `.html` files (like `index.html`) directly in your web browser to view the website.
